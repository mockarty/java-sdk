...
| [`DiscoveryExample.java`](./examples/src/main/java/ru/mockarty/examples/DiscoveryExample.java) | Syncs a test-discovery manifest into TCM via `client.discovery().syncDiscovery(...)`, and documents the JUnit5 auto-discovery listener switch. |
